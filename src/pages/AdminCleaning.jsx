...
function AdminCleaning() {
    ...
    async function deleteRegistro(id) {
        toast((t) => (
            <div className="flex flex-col gap-3">
                <p className="text-sm font-black text-white uppercase tracking-tight">Excluir este registro?</p>
    ...
    async function deleteLocal(id) {
        toast((t) => (
            <div className="flex flex-col gap-3">
                <p className="text-sm font-black text-white uppercase tracking-tight">Excluir este local? Isso pode afetar o histórico.</p>
                <div className="flex gap-2">
                    <button 
                        onClick={async () => {
                            toast.dismiss(t.id);
